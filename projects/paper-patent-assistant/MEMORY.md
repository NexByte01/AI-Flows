...
- **目标用户**：`硕博个人`
- **次级用户**：`高校课题组`
- **行业包策略**：`煤化工 / 能源化工` 为默认示例行业包，可按需切换到其他领域包
...
| 商业主线 | **Science Workflow** | 首版聚焦通用 SCI/期刊论文与硕博论文，煤化工/能源化工作为可切换行业包，专利降为可选 extension | 2026-06-09 |
...
- 煤化工/能源化工领域包是默认示例行业包，不作为主标题；通用写作内核仍需保持可迁移。
...
| 2026-06-05 | 商业化转向 Science Workflow | 面向硕博个人，主线改为 SCI/期刊论文与硕博论文；煤化工保留为默认示例行业包，专利降为插件 |
| 2026-06-09 | 通用化再平衡 | 主线叙事改为通用科研写作 + 可切换行业包，煤化工从主定位退回示例层 |
