...
Science Workflow 是一个面向硕博个人的 UI-less 科研写作 Agent 工作流。首版主线覆盖 SCI/期刊论文和硕博论文，煤化工/能源化工是第一垂直领域，专利能力保留为可选 extension。
...
| 煤化工领域包 | `_shared/domain/ai-coal-chem.md` | 提供煤气化、热化学、过程模拟、AI for Science 和工业控制语境 |
...
graph TD
    ...
    Science --> Domain["Coal-Chem Domain Pack"]
...
- 煤化工领域包优先服务自用和第一垂直商业场景，但不应把通用写作内核写死到单一学科。
...
| 2026-06-05 | 转向 Science Workflow | 商业主线调整为 SCI/期刊论文和硕博论文，煤化工为第一垂直，专利降为 extension |
