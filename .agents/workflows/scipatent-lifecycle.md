---
description: 重定向到当前项目的专利 extension 工作流
---

# SciPatent Patent Extension Redirect
...
本工作流是 Science Workflow 的可选专利 extension，通过设置 **6 个关键的人工审核与分支选择门槛 (Gates)**，确保科研过程的严谨性与控制灵活性：
